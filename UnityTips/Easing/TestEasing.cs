...
/// <summary>
/// Script for testing how affect easings functions to translations.
/// HOW TO USE:
/// - Attach this script to a GameObject in current Scene.
/// - Set up the component: select the easing function you want to test, set the duration of the animation and the goal transform.
/// - Call StartAnimation to see the animation. E.g. you can bind the OnClick event of a button to StartAnimation method.
/// </summary>
public class TestEasings : MonoBehaviour
{
    [SerializeField]
    ...
    {
        // Reset position and stop current animation
        StopAllCoroutines();
    ...
    private IEnumerator UpdateAnimation()
    {
        ...
        while (progress <= 1f)
        {
            ...
            transform.position = Vector3.Lerp(_initialPosition, _target.position, Easings.Interpolate(progress, _easingFunction));
            yield return null;
        }
    }
    ...
    /// <summary>
    /// @author https://github.com/acron0/Easings
    /// </summary>
